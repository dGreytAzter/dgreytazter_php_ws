...
<html>
  ...
  // fragments
      ...
      function Headers($headerIcons) {
        $icons = '';
        foreach($headerIcons as $headerIcon => $icon) {
          $icons .= '<li><a href="'.$headerIcon.'"><i class="'.$icon.'"></i></a></li>';
        }
...
MAINHEADER;
  ...
  function setNavbar($links) {
    $navLinks = '';
    foreach($links as $link => $menu) {
      $navLinks .= '<li><a href="'.$link.'">'.$menu.'</a></li>';
    };
...
NAV;
  ...
  $defaultSetLinkMenu = array(
    "tempaltemo_top" => "Home",
    "templatemo_services" => "Services",
    "templatemo_portfolio" => "Portfolio",
    "templatemo_about" => "About",
    "templatemo_contact" => "Contact"
  );

  echo setNavbar($defaultSetLinkMenu);
  ?>
